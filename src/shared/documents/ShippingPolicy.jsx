  ...
  return (
    <div className="pb-48 max-w-[1440px] px-10 mx-auto py-8 text-secondary [&_h2]:text-primary [&_h1]:text-primary [&_h3]:text-primary [&_a]:text-accentSecondary">
      ...
      <section className="mt-8">
        ...
        <p>
          Please note that shipping times are estimates and begin from the date of shipping rather than the date of
          order. Delivery times may vary due to factors beyond our control, such as weather conditions, postal delays,
          or holidays.
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <p>
          Shipping costs are calculated based on the weight, size, and destination of your order. You can view an
          estimated shipping cost at checkout before finalizing your purchase. For orders qualifying for free shipping,
          no shipping cost will be applied.
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <p>
          Orders are typically processed within 2 business days of order confirmation. Orders placed on weekends or
          holidays will be processed the next business day. We strive to dispatch your products as quickly as possible
      ...
      <section className="mt-8">
        ...
        <p>
          ...
          number to track your shipment’s progress to your doorstep.
        </p>
      </section>

      <section className="mt-8">
        <h2 className="text-2xl font-semibold mb-4">Shipping Carriers</h2>
        <p>We partner with reputable carriers to ensure your order arrives safely and on time.</p>
      </section>

      <section className="mt-8">
        <h2 className="text-2xl font-semibold mb-4">Lost or Damaged Items</h2>
        <p>
          If your order arrives damaged or is lost in transit, please contact us immediately at 9862306075. We will work
          with you to resolve the issue, whether it be sending a replacement or issuing a refund.
        </p>
      </section>
