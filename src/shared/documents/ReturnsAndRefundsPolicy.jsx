  ...
  return (
    <div className="pb-48 max-w-[1440px] px-10 mx-auto py-8 text-secondary [&_h2]:text-primary [&_h1]:text-primary [&_h3]:text-primary [&_a]:text-accentSecondary">
      ...
      <section className="mt-6">
        <p>
          Thank you for shopping at CHULIBAN HOTEL, your go-to destination for the finest everyday products. We stand
      ...
      <section className="mt-8">
        ...
        <p>
          30-Day Return Policy: You can return most items purchased from CHULIBAN HOTEL within 30 days of the delivery
          date.
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <ul className="pl-6 list-disc">
          <li>
            Items must be in their original condition, unused, and with all original packaging, accessories, and
            manuals.
          </li>
      ...
      <section className="mt-8">
        ...
        <ul className="pl-6 list-decimal">
          <li>
            <strong>Contact Customer Service:</strong> Before returning an item, contact our customer service at
            9862306075 to initiate the return process. We will provide a Return Merchandise Authorization (RMA) number
            and instructions.
          </li>
          <li>
            <strong>Packaging Your Return:</strong> Carefully pack the item in its original packaging, including all
            accessories. Write the RMA number clearly on the package.
          </li>
          <li>
          ...
          <li>
            <strong>Refund Processing:</strong> Once we receive and inspect the returned item, refunds will be processed
            to the original payment method within 7 business days. Shipping and handling fees are non-refundable.
          </li>
        </ul>
      </section>
      ...
      <section className="mt-8">
        ...
        <p>
          If you received a defective or incorrect item, please contact us within 3 days of receiving your order to
          arrange an exchange.
        </p>
      </section>
      ...
      <section className="mt-8">
        <p>We value your business and are here to ensure your satisfaction with every purchase from CHULIBAN HOTEL.</p>
      </section>
    </div>
  )
})
