  ...
  return (
    <div className="pb-48 max-w-[1440px] px-10 mx-auto py-8 text-secondary [&_h2]:text-primary [&_h1]:text-primary [&_h3]:text-primary [&_a]:text-accentSecondary">
      ...
      <section className="mt-8">
        ...
        <p>
          Customers can request order cancellations within 48 hours of placing an order. Refunds will be processed
          within 5 business days, and funds will be returned to the original payment method. No cancellations are
          accepted at the time of delivery.
        </p>
        <h3 className="text-xl font-semibold mt-4">Refund Policy</h3>
        <p>
          Customers dissatisfied with a received product can request a refund within 3 working days. Refunds are granted
          if the product does not match the website description or arrives damaged. Warranty-related service will be
          provided by the manufacturing company at their service center.
        </p>
      </section>
      ...
      <section className="mt-8">
        <p>
          By using this website, you acknowledge that you have read, understood, and agreed to these Terms and
          Conditions.
        </p>
      </section>
    </div>
